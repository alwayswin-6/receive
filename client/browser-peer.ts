const payloadOutput = document.getElementById('payloadOutput') as HTMLTextAreaElement;
const createOfferButton = document.getElementById('createOfferBtn') as HTMLButtonElement;
